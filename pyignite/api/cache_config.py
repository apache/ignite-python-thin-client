...
def cache_get_configuration(connection: 'Connection', cache: CacheInfo, query_id=None) -> 'APIResult':
    """
    ...
    """
    return __cache_get_configuration(connection, cache, query_id)


async def cache_get_configuration_async(connection: 'AioConnection', cache: CacheInfo, query_id=None) -> 'APIResult':
    """
    Async version of cache_get_configuration.
    """
    return await __cache_get_configuration(connection, cache, query_id)
...
def __cache_get_configuration(connection, cache, query_id):
    query_struct = Query(
